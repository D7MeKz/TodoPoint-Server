...
func (m *ProfileMutation) SetImgURL(s string) {
	m.img_url = &s
}

// ImgURL returns the value of the "img_url" field in the mutation.
func (m *ProfileMutation) ImgURL() (r string, exists bool) {
	v := m.img_url
	if v == nil {
		return
	}
...
// OldImgURL returns the old "img_url" field's value of the Profile entity.
// If the Profile object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ProfileMutation) OldImgURL(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ProfileMutation) ClearImgURL() {
	m.img_url = nil
	m.clearedFields[profile.FieldImgURL] = struct{}{}
}

// ImgURLCleared returns if the "img_url" field was cleared in this mutation.
func (m *ProfileMutation) ImgURLCleared() bool {
	_, ok := m.clearedFields[profile.FieldImgURL]
	return ok
}

// ResetImgURL resets all changes to the "img_url" field.
func (m *ProfileMutation) ResetImgURL() {
	m.img_url = nil
	delete(m.clearedFields, profile.FieldImgURL)
}
...
func (m *ProfileMutation) Fields() []string {
	...
	if m.img_url != nil {
		fields = append(fields, profile.FieldImgURL)
	}
	if m.created_at != nil {
...
func (m *ProfileMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(profile.FieldImgURL) {
		fields = append(fields, profile.FieldImgURL)
	}
	return fields
}
