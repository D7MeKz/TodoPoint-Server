...
func (e MemberEdges) PointInfoOrErr() ([]*PointInfo, error) {
	if e.loadedTypes[0] {
...
// QueryPointInfo queries the "point_info" edge of the Member entity.
func (m *Member) QueryPointInfo() *PointInfoQuery {
	return NewMemberClient(m.config).QueryPointInfo(m)
}

// QueryTasks queries the "tasks" edge of the Member entity.
func (m *Member) QueryTasks() *TaskQuery {
	return NewMemberClient(m.config).QueryTasks(m)
}
