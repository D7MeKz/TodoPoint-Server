...
func (baq *BankAccountQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (baq *BankAccountQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(bankaccount.Table, bankaccount.Columns, sqlgraph.NewFieldSpec(bankaccount.FieldID, field.TypeInt))
	_spec.From = baq.sql
